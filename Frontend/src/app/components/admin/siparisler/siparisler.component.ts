...
export class SiparislerComponent implements OnInit {
  ...
  Sil(kayit: Siparis) {
    ...
    this.confirmdialogRef.componentInstance.dialogMesaj = kayit.SiparisKod + " Kodlu " + kayit.SiparisUrunAdi + '  Ürünün Siparişi Silinecektir Onaylıyor Musunuz?';
