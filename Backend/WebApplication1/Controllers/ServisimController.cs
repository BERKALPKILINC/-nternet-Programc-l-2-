...
namespace Sporties.Controllers
{
    public class ServisController : ApiController
    {
        ...
        public SonucModel UrunDuzenle(UrunModel model)
        {
            ...
            if (model.UrunAdi == null || model.UrunAdi == "")
            {
                model.UrunAdi = kayit.UrunAdi;
            }
            if (model.UrunFiyat == null)
            {
                model.UrunFiyat = kayit.UrunFiyat;
            }
            if (model.UrunAdet == null)
            {
                model.UrunAdet = kayit.UrunAdet;
            }
            if (model.UrunKodu == null || model.UrunKodu == "")
            {
                model.UrunKodu = kayit.UrunKodu;
            }
            if (model.UrunFoto == null || model.UrunFoto == "")
            {
                model.UrunFoto = kayit.UrunFoto;
            }
            if (model.UrunKategoriId == null)
            {
                model.UrunKategoriId = kayit.UrunKategoriId;
            }
            if (model.UrunMarkaId == null)
            {
                model.UrunMarkaId = kayit.UrunMarkaId;
            }
        ...
        public SonucModel UyeDuzenle(UyeModel model)
        {
            ...
            if (model.UyeAdi == null || model.UyeAdi == "")
            {
                model.UyeAdi = kayit.UyeAdi;
            }
            if (model.UyeSoyadi == null || model.UyeSoyadi == "")
            {
                model.UyeSoyadi = kayit.UyeSoyadi;
            }
            if (model.UyeKA == null || model.UyeKA == "")
            {
                model.UyeKA = kayit.UyeKA;
            }
            if (model.UyeKS == null || model.UyeKS == "")
            {
                model.UyeKS = kayit.UyeKS;
            }
            if (model.UyeTel == null || model.UyeTel == "")
            {
                model.UyeTel = kayit.UyeTel;
            }
            if (model.UyeMail == null || model.UyeMail == "")
            {
                model.UyeMail = kayit.UyeMail;
            }
            if (model.UyeAdres == null || model.UyeAdres == "")
            {
                model.UyeAdres = kayit.UyeAdres;
            }
            if (model.UyeYetki == null)
            {
                model.UyeYetki = kayit.UyeYetki;
            }
